...
- `public/` – содержит все статичные файлы: _шрифты, картинки, манифесты, etc_. <br /> Всю статитку храним тут.
...
- `public/img/sprite` – папка для SVG-иконок, компилируемых в спрайт. Перед названием используем префикс `icn-`
